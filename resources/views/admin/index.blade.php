                    ...
                    <div class="row" style="font-size:13px!important;text-align:center!important">
                        ...
                        <div class="col-md-3 ">
                            ...
                            <div class="border_Shadow">
                                ...
                                <div style="margin-right:10px;">
                                    <span
                                        style="display:block;color:#645ca8;margin-bottom:10px;">ترم های بسته شده</span>
                                    <span style="font-weight:bold;">  </span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 ">
                            ...
                            <div class="border_Shadow">
                                ...
                                <div style="margin-right:10px;">
                                    <span
                                        style="display:block;color:#645ca8;margin-bottom:10px;">آمار فارغ التحصیلان</span>
                                    <span style="font-weight:bold;"> </span>
                                </div>
                            </div>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div style="margin-bottom:10px;"><a href="/admin/create" class="btn btn-primary"
                                                                id="New_Hmi">استخدام نیرو جدید</a></div>
                            <table class="table table-striped">
                                ...
                                @foreach($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{--  options filed--}}
                                            <button class="btn btn-info"><a href="/admin/{{$user->id}}"
                                                                            style="color: white;">جزییات</a></button>
                                            <button class="btn btn-warning"><a href="/admin/{{$user->id}}/edit"
                                                                               style="color: white;">ویرایش</a></button>
